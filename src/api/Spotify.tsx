...
function stopSnippet(){
  ...
  return (
    <div id='AltSpotify'>
    <div className="artist-header text-5xl pb-6">
    ...
    <div className=" items-center w-full flex flex-row opposite-fade">
        <div className="artist text-white w-1/3 mt-10">
            <div className="image-container-artist items-center">
              <img onClick={clickedEventDylan} src={Dylan} alt="bob dylan" className='ml-14 rounded-full border-2 p-2 hover:border-red-500 hover:blur-sm  cursor-pointer'/>
            </div>
            ...
            <div className="artist-socials text-center space-x-4 pb-20">
                <a href="https://www.instagram.com/bobdylan" target="_blank"><i className="fab fa-instagram hover:text-red-600 text-black"></i></a>
        ...
        <div className="artist text-white w-1/3 mt-10">
            <div className="image-container-artist">
                <img onClick={clickedEventPrince} className='ml-14 rounded-full border-2 p-2 hover:border-red-500 hover:blur-sm  cursor-pointer' src={Prince} alt="prince" />
            </div>
            <div className="artist-name text-center text-2xl">
                <h1 className='pt-10'>Prince</h1>
            </div>
            <p className="artist-info text-center mx-14">Prince Rogers Nelson, songwriter, singer, producer, and all-round musical 
            ...
            <div className="artist-socials text-center space-x-4 pb-20">
                <a href="https://www.instagram.com/prince" target="_blank"><i className="fab fa-instagram hover:text-red-600 text-black"></i></a>
        ...
        <div className="artist text-white w-1/3 mt-10">
            <div className="image-container-artist">
                <img onClick={clickedEventGravy} className='ml-14 rounded-full border-2 p-2 hover:border-red-500 hover:blur-sm cursor-pointer' src={Gravy} alt="yung gravy" />
            </div>
            <div className="artist-name text-center text-2xl">
